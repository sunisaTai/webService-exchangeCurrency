...
import com.exc.exchangecurrency.security.AppRoleDataOnDemand;
...
privileged aspect AppRoleDataOnDemand_Roo_DataOnDemand {
    ...
    public AppRole AppRoleDataOnDemand.getNewTransientAppRole(int index) {
        ...
        setWorkflowPassword(obj, index);
        setWorkflowUser(obj, index);
        return obj;
    }
    ...
    public void AppRoleDataOnDemand.setHrRole(AppRole obj, int index) {
        String hrRole = "hrRole_" + index;
        obj.setHrRole(hrRole);
    }
    ...
    public void AppRoleDataOnDemand.setWorkflowPassword(AppRole obj, int index) {
        String workflowPassword = "workflowPassword_" + index;
        obj.setWorkflowPassword(workflowPassword);
    }
    
    public void AppRoleDataOnDemand.setWorkflowUser(AppRole obj, int index) {
        String workflowUser = "workflowUser_" + index;
        obj.setWorkflowUser(workflowUser);
    }
