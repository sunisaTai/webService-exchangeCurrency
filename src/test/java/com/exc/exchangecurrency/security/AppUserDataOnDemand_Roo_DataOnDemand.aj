...
import com.exc.exchangecurrency.security.AppUserDataOnDemand;
...
privileged aspect AppUserDataOnDemand_Roo_DataOnDemand {
    ...
    public void AppUserDataOnDemand.setDefaultLang(AppUser obj, int index) {
        String defaultLang = "defaultLang_" + index;
        obj.setDefaultLang(defaultLang);
    }
    ...
    public void AppUserDataOnDemand.setManager(AppUser obj, int index) {
